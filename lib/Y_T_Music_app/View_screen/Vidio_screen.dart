...
import '../Provider/Y_T_provider_screen.dart';

class Vidio_acreen extends StatefulWidget {
  const Vidio_acreen({Key? key}) : super(key: key);

  @override
  State<Vidio_acreen> createState() => _Vidio_acreenState();
}

class _Vidio_acreenState extends State<Vidio_acreen> {
